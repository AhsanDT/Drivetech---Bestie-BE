  ...
  def create
    if @booking.present?
      if @current_user.profile_type == "bestie" || "Bestie"
        ...
        Notification.create(subject: "Review", body: "#{@current_user.full_name} gave you feedback and posted a review on your profile.", notification_type: "Review", user_id: @review.review_to_id, send_by_id: @current_user.id, send_by_name: @current_user.full_name, booking_sender_id: @booking.send_by_id)
      else
