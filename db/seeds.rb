...
Talent.destroy_all
Talent.create(title: 'Photography')
Talent.create(title: 'Film Photography')
Talent.create(title: 'Wedding Photography')
Talent.create(title: 'Styling')
Talent.create(title: 'Food Photography')
Talent.create(title: 'Clothing Photography')
Talent.create(title: 'Analytics')
Talent.create(title: 'Ecommerce Photography')
Talent.create(title: 'Branding')
Talent.create(title: 'Campaign Photography')
Talent.create(title: 'Tech Savy')
Talent.create(title: 'Sports Photography')
Talent.create(title: 'Merchandising')
Talent.create(title: 'Beauty Photography')
Talent.create(title: 'Organization')
Talent.create(title: 'Cosmetic Photography')
Talent.create(title: 'Advertising')
Talent.create(title: 'Event Photography')
Talent.create(title: 'Videography')
Talent.create(title: 'Influencer / Content Creator')
Talent.create(title: 'Animal Photography')
Talent.create(title: 'Hair Stylist')
Talent.create(title: 'Makeup Artist')
Talent.create(title: 'Social Media')
Talent.create(title: 'Content Creator')
Talent.create(title: 'Video Creator')
Talent.create(title: 'Video Editing')
Talent.create(title: 'Picture Editing')
Talent.create(title: 'Video Editor')
Talent.create(title: 'Photoshop')
Talent.create(title: 'PTalent')
Talent.create(title: 'TikTok')
Talent.create(title: 'YouTube')
Talent.create(title: 'Canva')
Talent.create(title: 'Adobe')
Talent.create(title: 'Microsoft Excel')
Talent.create(title: 'Google Calender')
Talent.create(title: 'Dropbox')
Talent.create(title: 'Google Drive')
Talent.create(title: 'Google Sheets')
Talent.create(title: 'Poshmark')
Talent.create(title: 'Depop')
Talent.create(title: 'Ebay')
